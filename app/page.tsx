        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-foreground">BlockSim</span>
            </div>
          ...
          >
            ...
            <div className="flex justify-center space-x-4">
              <Link href="/simulator">
                <Button
                  size="lg"
                  className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
                  Try Simulator
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-primary/50 hover:bg-primary/10 px-8 py-6 text-lg font-semibold rounded-xl transition-all duration-300 hover:scale-105"
              >
        ...
        <footer className="py-12 border-t border-border bg-card/50">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center">
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-foreground mb-2">Developed by Students of</h3>
                <p className="text-sm text-primary font-medium">Annamacharya Institute of Technology and Sciences Tirupati</p>
              </div>
              
              <div className="flex flex-col items-center gap-4 mb-6 text-sm">
                <div className="flex flex-row gap-4">
                  <div className="flex flex-col items-center p-4 rounded-lg bg-primary/10 border-2 border-primary/50 hover:bg-primary/20 transition-all transform hover:scale-105 w-48">
                    <a href="#" className="text-foreground hover:text-primary font-medium transition-colors">Janaka Tejeswar</a>
                    <span className="text-primary text-xs font-bold">23AK1A3621</span>
                  </div>
                  <div className="flex flex-col items-center p-4 rounded-lg bg-primary/10 border-2 border-primary/50 hover:bg-primary/20 transition-all transform hover:scale-105 w-48">
                    <a href="#" className="text-foreground hover:text-primary font-medium transition-colors">Manasa C</a>
                    <span className="text-primary text-xs font-bold">23AK1A3623</span>
                  </div>
                </div>
                <div className="flex flex-row gap-4">
                  <div className="flex flex-col items-center p-4 rounded-lg bg-primary/10 border-2 border-primary/50 hover:bg-primary/20 transition-all transform hover:scale-105 w-48">
                    <a href="#" className="text-foreground hover:text-primary font-medium transition-colors">Pradeep Kumar Pulipati</a>
                    <span className="text-primary text-xs font-bold">24AK5A3605</span>
                  </div>
                </div>
                <div className="flex flex-row gap-4">
                  <div className="flex flex-col items-center p-4 rounded-lg bg-background/50 hover:bg-background/80 transition-colors w-48">
                    <a href="#" className="text-foreground hover:text-primary font-medium transition-colors">V Charan Sai</a>
                    <span className="text-muted-foreground text-xs">24AK1A3605</span>
                  </div>
                  <div className="flex flex-col items-center p-4 rounded-lg bg-background/50 hover:bg-background/80 transition-colors w-48">
                    <a href="#" className="text-foreground hover:text-primary font-medium transition-colors">C Rajesh</a>
                    <span className="text-muted-foreground text-xs">24AK1A3633</span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center text-sm text-muted-foreground">
                <p className="mb-2">
                  <a href="/blockchain-simulator" className="text-foreground hover:text-primary transition-colors font-medium">
                    BlockSim
                  </a>
